...
export default function Paciente({paciente, setPaciente, eliminarPaciente}) { 
  ...
  const {nombre, propietario, email, fecha, sintomas,telefono, id} = paciente // destructuramos para no poner nombre. asi queda mas limpio

  const handleEliminar = () => { // boton para confirmar eliminacion que se pasa eliminarpaciente(id) para que lance esa funcion dependiendo la respuesta
